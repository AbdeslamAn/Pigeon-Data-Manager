...
<body style="background-color: lightgrey;">
    ...
    <table border="1" cellspacing="0" cellpading="0" style="background-color:  #3D405B;width:;">
            ...
            <td rowspan="16">
                <div class="class1">
                    <center><button style="width: max-content;height: max-content;margin-bottom: 0%;" ><label style="color: red;font-size=22px;cursor:auto;" name="label1"><?php echo $label1; ?></label></button></center> 
                    <textarea name="textarea1" id=""  cols="25"   rows="25"    disabled style="font-size=24px;">"<?php echo  $nam_pig ; ?>"<?php echo "\n".$ad_info; ?></textarea>
        ...
        <tr>
            <td rowspan="8">
                ...
                <div class="box">
                    ...
                    <center><a class="button" href="les_pedegree/pedegree3.php?label2=<?php echo urlencode($label2); ?>&label1=<?php echo urlencode($label1); ?>&label3=<?php echo urlencode($label3); ?>&ad_info=<?php echo urlencode($ad_info); ?>&nam_pig=<?php echo urlencode($nam_pig); ?>"><button type="button" style="width: max-content;height: max-content;margin-bottom: 0%;"><label style="color: red;"name="label2"><?php echo $label2; ?></label></button></a></center>
