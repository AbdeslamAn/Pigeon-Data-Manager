...
<label style="color: red;"name="label2" hidden><?php echo $label2; ?></label>
<label style="color: red;"name="label2" hidden><?php echo $label3; ?></label>
<textarea name="textarea1" id=""  cols="25"   rows="25"    disabled style="font-size=24px;" hidden>"<?php echo  $nam_pig ; ?>"<?php echo "\n".$ad_info; ?></textarea>
...
<div style="width:50%;">
    ...
    <form action="pede_gree50.php" method="post" >
...
<input type="text" 
           ...
           <div class="">
               <input type="text" name="n_bage" id="" class="form-control"  disabled value="<?php echo htmlspecialchars($label2); ?>"  pattern="[a-zA-Z]+-[0-9]+-[0-9]{2}"  title="Please enter the input in the format: [letters]-[numbers]-[2 digits]" placeholder="MAC-0000-17"  style="color:black; font-size:20px;text-align:center;">
       ...
       <a href="../pedegree2.php?label2=<?php echo urlencode($label2); ?>&label1=<?php echo urlencode($label1); ?>&label3=<?php echo urlencode($label3); ?>&ad_info=<?php echo urlencode($ad_info); ?>&nam_pig=<?php echo urlencode($nam_pig); ?>"><button style="--clr:#F3bc06;"  type="submit" class="button1" ><span><b>Next</b> </span><i class="i1"></i></button></a>
                   <br><br><br>
</form>
</div>
