...
if (isset($_POST['n_bage']) &&
    ...
    isset($_POST['id_pig_sq'])) {
		...
		$sql = "UPDATE pigeon_squab SET n_bage='$n_bage', date_naiss='$date_naiss', strains='$straines', n_father='$bage_father', n_mother='$bage_mother', not_info='$note',user_email='$user_email' WHERE id_pig_sq='$id_pig_sq'";
		$result = mysqli_query($connection, $sql);
