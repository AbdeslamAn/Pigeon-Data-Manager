...
<body style="background-color: lightgrey;">
    ...
    <div class="col-lg-5 col-12 mx-auto" style="margin-top: 0.5%;width:60%;background-color: #3D405B; border-radius: 20px;margin-bottom:10% ;margin-top:10% ;">
            ...
            <form action="edit_php_piegon.php" method="post" class="" >
            <a href="pigeons.php" style="margin-top:10px;margin-left:10px;"><img src="../images/retour.png" width="50px" height="50px"></a>
           ...
           <center>
          <div style="width:60%;">
            <h2 class="text-white mb-4">Change Your info Pigeon</h2>
           ...
           <div class="form-floating">
               <input type="text" name="name_pig" id="full-name" class="form-control"  value="<?=$user['name_pig']?>" placeholder="Name Pigeon" style="color:black; font-size:20px;">
               
               <label for="floatingInput" style="color:black; font-size:20px;">Name Pigeon</label>
           </div>
           <div class=""><center>
           
           <input type="radio" required name="genre" value="male"    <?php echo ($user['gander'] == "male")?"checked":"" ?> ><label for=""style="color:black;font-weight: bold;">Male</label>
        <input type="radio" required name="genre" value="female"    <?php echo ($user['gander'] == "female")?"checked":"" ?> ><label for=""style="color:black;font-weight: bold;">Female</label> 
           </div>
           <div class="form-floating">
           ...
           <input type="radio" required name="pig_squab" value="pigeon"    <?php echo ($user['pig_squab'] == "pigeon")?"checked":"" ?> ><label for=""style="color:black;font-weight: bold;">Pigeon</label>
        <input type="radio" required name="pig_squab" value="squab"    <?php echo ($user['pig_squab'] == "squab")?"checked":"" ?> ><label for=""style="color:black;font-weight: bold;">Squab</label> 
           </div>
           <div class="form-floating">
           ...
           <div class="form-floating">
               <input type="text" name="user_email" id="full-name" class="form-control" value="<?=$user['user_email']?>" placeholder="N° Bage Mother" required="" style="color:black; font-size:20px;">
               
               <label for="floatingInput" style="color:black; font-size:20px;">User Email</label>
           </div>
           <label for="" style="color:white; font-size:25px;"><h4>Upload Image of Piegon:</h4></label>
            <br>
            <div class="form-floating">
          
            <input type="file" name="picture3" onchange="previewPicture(this)"   >
                    <img src="../user/php/<?php echo $user['img_pig']?>"  alt="" id="image2Preview"  name="my_image" style="max-width: 500px; margin-top: 20px;" >
    ...
    function previewPicture(event) {
        ...
        if (file) {
            ...
            reader.onload = function() {
                ...
                } else if (event.target.name === "picture3") {
...
<?php 
	    ...
	    header("Location: pigeons.php?$ms=wahassan2");
	    exit;
	} 

}
else {
    header("Location: pigeons.php?$ms=wahassan");
    exit;
} 
?>