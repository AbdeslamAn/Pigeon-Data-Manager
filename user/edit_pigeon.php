...
<body style="background-color: lightgrey;">
    ...
    <div class="col-lg-5 col-12 mx-auto" style="margin-top: 0.5%;width:60%;background-color: #3D405B; border-radius: 20px;margin-bottom:10% ;margin-top:10% ;">
            ...
            <form action="php/edit_piegon.php" method="post" class="" >
            <a href="my_pigeon.php" style="margin-top:10px;margin-left:10px;"><img src="../images/retour.png" width="50px" height="50px"></a>
        ...
        <input type="radio" required name="genre" value="female"    <?php echo ($user['gander'] == "female")?"checked":"" ?> ><label for=""style="color:black;font-weight: bold;">Female</label> 
           ...
           <label for="" style="color:white; font-size:25px;"><h4>Upload Image of Piegon:</h4></label>
            ...
            <input type="file" name="picture3" onchange="previewPicture(this)"   >
                    <img src="php/<?php echo $user['img_pig']?>"  alt="" id="imagePreview"  name="my_image" style="max-width: 500px; margin-top: 20px;" >
          ...
          <br>
            ...
            <input type="file" name="picture" onchange="previewPicture(this)"   >
                    <img src="php/<?php echo $user['ped_father']?>"  alt="" id="imagePreview"  name="my_image" style="max-width: 500px; margin-top: 20px;" >
          ...
          <br>
           ...
           <label for="" style="color:white; font-size:22px;"><h4>Upload pedigree of Mother:</h4></label>
            ...
            <input type="file" name="picture2" onchange="previewPicture(this)"   >
                    <img src="php/<?php echo $user['ped_mother']?>" id="image1Preview"  alt=""  name="my_image" style="max-width: 500px; margin-top: 20px;" >
...
<br>
    ...
    var image1Preview = document.getElementById("image2Preview");
...
<?php 
	    ...
	    header("Location: my_pigeon.php?$ms=wahassan2");
	    exit;
	} 

}
else {
    header("Location: my_pigeon.php?$ms=wahassan");
    exit;
} 
?>