...
<div style="width:50%;">
    ...
    <form action="php/create_pigeon.php" method="post" enctype="multipart/form-data">
...
<input type="text" 
        ...
        <input type="radio" required name="genre" value="female"     ><label for=""style="color:black;font-weight: bold;">Female</label> 
           ...
           <div class="form-floating">
               <input type="text" name="strains" id="full-name" class="form-control" required="" placeholder="Date of Birth" style="color:black; font-size:20px;">
               
               <label for="floatingInput" style="color:black; font-size:20px;">Straines</label>
           </div>
           <div class="form-floating">
               <input type="text" name="color" id="full-name" class="form-control" required="" placeholder="Date of Birth" style="color:black; font-size:20px;">
        ...
        <br>
           ...
           <label style="color:black;font-weight: bold; font-size:20px;">Note :</label><br>
