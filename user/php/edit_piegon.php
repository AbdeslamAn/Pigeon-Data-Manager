...
if (isset($_POST['n_bage']) &&
    ...
    isset($_POST['id_pig_sq'])) {
		...
		if (mysqli_num_rows($result) <= 0) {
			header("Location: ../my_piegon.php?ms=Pigeon not found");
			exit;
		}
	...
	$note = $_POST['note'];
		...
		$sql = "UPDATE pigeon_squab SET n_bage='$n_bage', strains='$straines', name_pig='$name_pigeon',color='$color',gander='$gander', n_father='$bage_father', n_mother='$bage_mother', not_info='$note' WHERE id_pig_sq='$id_pig_sq'";
		$result = mysqli_query($connection, $sql);
		...
		header("Location: ../pigeon.php?ms=hello");
		exit;
	}
?>
