...
if (!empty($searchTerm)) {
    ...
    $query = "SELECT * FROM pigeon_squab WHERE n_bage LIKE '%{$searchTerm}%' or user_email LIKE '%{$searchTerm}%' ";
...
<body style="background-color: lightgrey;">
    <div class="content read" style="margin-top:200px; background-color:#3D405B;width:99%;">  
        <a href="squab2.php" style="margin-left:5%;margin-top:20px"><img src="../images/retour.png" width="50px" height="50px" style="margin-top:20px;margin-bottom: 10px;"></a>
