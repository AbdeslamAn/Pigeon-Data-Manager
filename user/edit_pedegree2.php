...
<body style="background-color: lightgrey;">
    ...
    " > <a href="pedigrees.php"><img src="../images/retour.png" width="50px" height="50px"></a>
            <center><?php if (isset($_GET['ms'])): ?>
            <p><?php echo $_GET['ms']; ?></p>
            <?php endif ?> 
           </center>
           <center><h2 class="text-white mb-4">Change Your Pedigree</h2></center>
 <center>
<div style="width:40%;">
...
<form action="php/edit_pedegree.php" method="post" enctype="multipart/form-data" >
...
<input type="text" 
           ...
           <div class="form-floating">
               <input type="text" name="n_bage" id="" class="form-control" value="<?=$user['n_bage']?>" pattern="[a-zA-Z]+-[0-9]+-[0-9]{2}"  title="Please enter the input in the format: [letters]-[numbers]-[2 digits]" placeholder="MAC-0000-17"  style="color:black; font-size:20px;margin-top:20px;">
        ...
        <input type="radio" required name="genre" value="yaung"    <?php echo ($user['gender'] == "yaung")?"checked":"" ?> ><label for=""style="color:black;font-weight: bold;">Yaung</label></center>
         ...
         <textarea  id="" cols="40" rows="10"  name="ad_info"  style="background: ;"><?php echo $user['ad_info']; ?></textarea>
        <br>
        <br>
        ...
        <img src="../php/<?=$user['img_dow']?>" alt="" id="image" name="my_image" style="max-width: 500px; margin-top: 20px;" >        </center>
        </center><br><br>
