...
<body style="background-color: lightgrey;">
    ...
    <div class="col-lg-5 col-12 mx-auto" style="margin-top: 0.5%;width:60%;background-color: #3D405B; border-radius: 20px;margin-bottom:10% ;margin-top:10% ;">
            ...
            <a href="squab2.php" style="margin-top:10px;margin-left:10px;"><img src="../images/retour.png" width="50px" height="50px"></a>
          ...
          <div style="width:60%;">
           ...
           <div class="form-floating">
               ...
               <label for="" ><h4 style="color:white; font-size:25px;">Upload pedigree of father:</h4></label>
            <br>
            <div class="form-floating">
          
            <input type="file" name="picture" id="fatherImageInput" onchange="previewPicture('fatherImageInput', 'fatherImagePreview')">
            <img src="php/<?php echo $user['ped_father']?>" alt="" id="fatherImagePreview" name="my_image" style="max-width: 500px; margin-top: 20px;">
           
        </div>
         
          <br>
         
           <label for="" ><h4 style="color:white; font-size:22px;">Upload pedigree of Mother:</h4></label>
            <br>
            <div class="form-floating">
            <input type="file" name="picture2" id="motherImageInput" onchange="previewPicture('motherImageInput', 'motherImagePreview')">
            <img src="php/<?php echo $user['ped_mother']?>" alt="" id="motherImagePreview" name="my_image" style="max-width: 500px; margin-top: 20px;">
           </div>
...
<br>
    ...
    function previewPicture(inputId, imageId) {
