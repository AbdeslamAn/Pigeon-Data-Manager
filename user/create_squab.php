...
<div style="width:50%;">
    ...
    <form action="php/create_squab.php" method="post" enctype="multipart/form-data">
...
<input type="text" 
           ...
           <div class="form-floating">
               <input type="date" name="date_naiss" id="full-name" class="form-control" required="" placeholder="Date of Birth" style="color:black; font-size:20px;">
               
               <label for="floatingInput" style="color:black; font-size:20px;">Date of Birth</label>
           </div>
           <div class=""><center>
           <input type="radio" required name="pig_squab" value="squab" checked hidden>
       

           </div>
       
           <div class="form-floating">
               <input type="text" name="straines" id="full-name" class="form-control" placeholder="Straines" style="color:black; font-size:20px;">
