            ...
            <nav class="navbar navbar-expand-lg" >                
                <div class="container"  style="margin-left: 4px;">
                    <a class="navbar-brand d-flex align-items-center" href="index.php">
                        <img src="images/logo.png" style="width: 157px;height: 101px;">
                    ...
                    <div class="d-lg-none ms-auto me-3" >
                        ...
                        <ul class="navbar-nav ms-lg-auto" >
                            <li class="nav-item dropdown" class="nav-item">
                                ...
                                <a  class="btn custom-btn custom-border-btn" data-bs-toggle="offcanvas"  href="#offcanvasExample" role="button" aria-controls="offcanvasExample" style="cursor : auto;font-size:20px;">  Connect <img src="images/iconprofil1.png" style="width:35px ; height:35px ;"></a>
                ...
                <div id=""  style="margin-right: 30px;" class="collapse navbar-collapse">
                        <ul class="navbar-nav ms-lg-auto">
                            <li class="nav-item dropdown" class="nav-item">
                                ...
                                <a  class="btn custom-btn custom-border-btn" style="cursor : auto;width:max-content;font-size:20px;"id="toggl1">  Connect <img src="images/iconprofil1.png" style="width:35px ; height:35px ;"></a>
                            
                            
                                

                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                    <li><a class="dropdown-item" href="login.php"  style="font-size:20px;color:black;">Login</a></li>

                                    <li><a class="dropdown-item" href="singup.php"  style="font-size:20px;color:black;">Sign Up</a></li>
                                </ul>
                            </li>
                            </ul>
...
We invite you to become a part of our vibrant community of pigeon racing enthusiasts. Together, we can celebrate the magic of pigeon racing, learn from each other, and inspire future generations of pigeon racers.
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-0">
                            <div class="member-block">
                                <div class="member-block-image-wrap">
                                    <img src="images/members/photo_5909011698440846255_y.jpg" class="member-block-image img-fluid" alt="">

                                   
                                </div>

                                <div class="member-block-info d-flex align-items-center" >
                                    <h4>     Abdslam Anssar</h4>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="member-block">
                                <div class="member-block-image-wrap">
                                    <img src="images/members/photo_5909011698440846254_y.jpg" class="member-block-image img-fluid" alt="">

                                </div>

                                <div class="member-block-info d-flex align-items-center">
                                    <h4>Abdullah Karia</h4>
 ...
 In this case, we guarantee you a special place to fill, store and refer to this information at any time.                
                        ...
                        <td scope="row" ><div class="container" >
                            ...
                            <div class=""  >
                                ...
                                <div class="">
                                    <div class="section-bg-image-block"  style="height: 336px;" >
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-12">
                        ...
                        <a href="singup.php"><p class=""><u>Sign Up</u></p></a><br>
                        <a href="login.php"><p class=""><u>Login</u></p></a>
                        ...
                        <div class="col-lg-2 col-12 ms-auto">
                            <ul class="social-icon mt-lg-5 mt-3 mb-4">
                                <li class="social-icon-item">
                                    <a href="https://instagram.com/fly_higher_8080?igshid=MzNlNGNkZWQ4Mg==" class="social-icon-link bi-instagram"  target="_blank"></a>
                                </li>
                            </ul>
